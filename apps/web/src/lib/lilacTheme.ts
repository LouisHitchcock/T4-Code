...
// Derived directly from the upstream Lilac VS Code extension theme.
export const LILAC_THEME_NAME = "lilac" as const;
export const LILAC_THEME_BACKGROUND = "#080709" as const;
export const LILAC_THEME_FOREGROUND = "#e0ceed" as const;

export const LILAC_THEME = {
  name: LILAC_THEME_NAME,
  type: "dark",
  colors: {
    foreground: "#e0ceed",
  ...
  fg: LILAC_THEME_FOREGROUND,
  bg: LILAC_THEME_BACKGROUND,
  settings: [
    {
      settings: {
        background: "#080709",
    ...
    { name: "Comment", scope: "comment", settings: { foreground: "#614e6e" } },
    { name: "String", scope: "string", settings: { foreground: "#f5b0ef" } },
    { name: "Number", scope: "constant.numeric", settings: { foreground: "#f25ae6" } },
    { name: "Built-in constant", scope: "constant.language", settings: { foreground: "#b657ff" } },
    {
      name: "User-defined constant",
      scope: ["constant.character", "constant.other"],
      settings: { foreground: "#b657ff" },
    },
    { name: "Variable", scope: "variable", settings: { fontStyle: "" } },
    { name: "Keyword", scope: "keyword", settings: { foreground: "#8e6da6" } },
    {
      name: "Storage",
      scope: "storage",
      settings: { fontStyle: "", foreground: "#b657ff" },
    },
    {
      name: "Storage type",
      scope: "storage.type",
      settings: { fontStyle: "", foreground: "#a29dfa" },
    },
    {
      name: "Class name",
      scope: "entity.name.class",
      settings: { fontStyle: "underline", foreground: "#b657ff" },
    },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: "", foreground: "#f5b0ef" },
    },
    {
      name: "Function argument",
      scope: "variable.parameter",
      settings: { fontStyle: "", foreground: "#e0ceed" },
    },
    {
      name: "Tag name",
    ...
    },
    {
      ...
      settings: { fontStyle: "", foreground: "#8e69c9" },
    },
    {
    ...
    { name: "Library variable", scope: "support.other.variable", settings: { fontStyle: "" } },
    {
      name: "Invalid",
      scope: "invalid",
      settings: { background: "#664e4d", foreground: "#cf433e", fontStyle: "" },
    },
    {
      name: "Invalid deprecated",
      scope: "invalid.deprecated",
      settings: { background: "#664e4d", foreground: "#cf433e" },
    },
    {
      name: "JSON String",
      scope: "meta.structure.dictionary.json string.quoted.double.json",
      settings: { foreground: "#f5b0ef" },
    },
    {
      name: "diff.header",
      scope: ["meta.diff", "meta.diff.header"],
      settings: { foreground: "#614e6e" },
    },
    { name: "diff.deleted", scope: "markup.deleted", settings: { foreground: "#e61f44" } },
    { name: "diff.inserted", scope: "markup.inserted", settings: { foreground: "#A6E22E" } },
    { name: "diff.changed", scope: "markup.changed", settings: { foreground: "#f7b83d" } },
    {
    ...
    { scope: "keyword.other", settings: { foreground: "#886f99" } },
    {
    ...
    },
    {
      ...
      settings: { foreground: "#a29dfa" },
    },
    {
      name: "Function argument",
      scope: ["meta.use support.class.builtin", "meta.other.inherited-class support.class.builtin"],
      settings: { foreground: "#a29dfa", fontStyle: "normal" },
    },
    {
      name: "Function argument",
      scope: "variable.other",
      settings: { foreground: "#e0ceed", fontStyle: "normal" },
    },
    {
      name: "Coffeescript Function argument",
      scope: "variable.parameter.function.coffee",
      settings: { foreground: "#f25ae6", fontStyle: "" },
    },
    {
    ...
    },
    {
      ...
      settings: { foreground: "#a29dfa", fontStyle: "" },
    },
    {
    ...
    },
    {
      ...
      settings: { foreground: "#664e4d" },
    },
    {
      name: "GitGutter deleted",
      scope: "markup.deleted.git_gutter",
      settings: { foreground: "#e61f44" },
    },
    {
      name: "GitGutter inserted",
      scope: "markup.inserted.git_gutter",
      settings: { foreground: "#a7da1e" },
    },
    {
      name: "GitGutter changed",
      scope: "markup.changed.git_gutter",
      settings: { foreground: "#f7b83d" },
    },
    {
